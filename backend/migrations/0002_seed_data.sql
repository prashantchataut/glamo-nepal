...
-- Blog Posts (3, matching frontend static data in blog-content.ts)
INSERT INTO blogs (id, title, slug, excerpt, content, category, tags, author_id, is_published, published_at, created_at, updated_at) VALUES
('blog_001', 'How to Build a Kathmandu Skincare Routine', 'kathmandu-skincare-routine', 'A practical GLAMO routine for sun, dust, humidity and seasonal dryness in Nepal.', '<h2>Start with the local context</h2><p>Kathmandu routines need to account for sun, dust, commute time, changing humidity and indoor dryness. Keep the routine simple, comfortable and consistent without overloading the skin.</p><h2>Morning routine</h2><p>Cleanse gently, use a light serum if desired, apply moisturizer, then finish with a generous layer of SPF. Reapply sunscreen during long outdoor days whenever possible.</p><h2>Evening routine</h2><p>Remove sunscreen and makeup fully, add a treatment product only when needed, and support the skin barrier with a comfortable moisturizer.</p>', 'Skincare', '["skincare","routine","kathmandu","nepal"]', 'u_admin_00000000', 1, datetime('now'), datetime('now'), datetime('now')),
('blog_002', 'Festival Makeup That Lasts', 'festival-makeup-that-lasts', 'Primer, tint, lip and setting tips for New Year, gifting and wedding events.', '<h2>Plan for long wear</h2><p>Festival days often include travel, food, photos and long family gatherings. Lightweight layers usually last better than one heavy layer.</p><h2>Choose flexible textures</h2><p>Skin tint, cream blush and a comfortable matte lip can create a polished look while still feeling wearable.</p><h2>Keep it realistic</h2><p>Choose long-wear products thoughtfully and carry a small touch-up pouch for lips, powder and blotting.</p>', 'Makeup', '["makeup","festival","long-wear","tutorial"]', 'u_admin_00000000', 1, datetime('now'), datetime('now'), datetime('now')),
('blog_003', 'Giftable Beauty Picks for Any Occasion', 'beauty-gift-guide', 'A simple beauty gift guide for skincare lovers, makeup minimalists and fragrance fans.', '<h2>Choose gifts by routine</h2><p>Skincare sets work well for customers who enjoy daily rituals, while lip and cheek tints are easy gifts for makeup lovers.</p><h2>Add a thoughtful finishing touch</h2><p>Fragrance, body care and a soft glam lip shade can make any beauty gift feel personal without being difficult to choose.</p>', 'Gift Guide', '["gift-guide","skincare","makeup","fragrance"]', 'u_admin_00000000', 1, datetime('now'), datetime('now'), datetime('now'));
