...
import { createCouponSchema, updateCouponSchema, validateCouponSchema, applyCouponSchema } from './coupon.schema'
...
couponRoutes.get('/', authMiddleware, requireRole(['ADMIN', 'SUPER_ADMIN']), getCoupons)
