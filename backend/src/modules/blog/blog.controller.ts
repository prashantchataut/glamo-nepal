...
export async function getBlogPosts(c: Context<AppEnv>) {
  try {
    ...
    const result = await BlogService.getPublishedBlogs(supabase, kv, filters)
...
export async function getBlogPostBySlug(c: Context<AppEnv>) {
  try {
    ...
    const supabase = c.get('supabase')
    const result = await BlogService.getBlogBySlug(supabase, slug)
...
export async function createBlogPost(c: Context<AppEnv>) {
  try {
    ...
    const supabase = c.get('supabase')
    const result = await BlogService.createBlog(supabase, data, user.id)
...
export async function updateBlogPost(c: Context<AppEnv>) {
  try {
    ...
    const supabase = c.get('supabase')
    const user = c.get('user')
    const result = await BlogService.updateBlog(supabase, id, data, user.id)
...
export async function publishBlogPost(c: Context<AppEnv>) {
  try {
    ...
    const supabase = c.get('supabase')
    const user = c.get('user')
    const result = await BlogService.publishBlog(supabase, id, user.id)
...
export async function unpublishBlogPost(c: Context<AppEnv>) {
  try {
    ...
    const supabase = c.get('supabase')
    const user = c.get('user')
    const result = await BlogService.unpublishBlog(supabase, id, user.id)
...
export async function deleteBlogPost(c: Context<AppEnv>) {
  try {
    ...
    const supabase = c.get('supabase')
    const user = c.get('user')
    await BlogService.deleteBlog(supabase, id, user.id)
