...
export async function getProducts(c: Context<AppEnv>) {
  try {
    ...
    const result = await ProductService.getProductsCached(filters, c.env.DB, c.env.KV)
...
export async function searchProducts(c: Context<AppEnv>) {
  try {
    ...
    const result = await ProductService.searchProducts(query, page, limit, c.env.DB)
...
export async function getProductBySlug(c: Context<AppEnv>) {
  try {
    ...
    const product = await ProductService.getProductBySlug(slug, c.env.DB, c.env.KV)
...
export async function createProduct(c: Context<AppEnv>) {
  try {
    ...
    const product = await ProductService.createProduct(data, user.id, c.env.DB, c.env.KV)
...
export async function updateProduct(c: Context<AppEnv>) {
  try {
    ...
    const product = await ProductService.updateProduct(id, data, user.id, c.env.DB, c.env.KV, c.env)
...
export async function deleteProduct(c: Context<AppEnv>) {
  try {
    ...
    await ProductService.softDeleteProduct(id, user.id, c.env.DB, c.env.KV)
...
export async function toggleFeatured(c: Context<AppEnv>) {
  try {
    ...
    const result = await ProductService.toggleFeatured(id, user.id, c.env.DB, c.env.KV)
...
export async function toggleHidden(c: Context<AppEnv>) {
  try {
    ...
    const result = await ProductService.toggleHidden(id, user.id, c.env.DB, c.env.KV)
...
export async function uploadProductImages(c: Context<AppEnv>) {
  try {
    ...
    const images = await ProductService.uploadProductImages(id, files, user.id, c.env.DB, c.env.KV, c.env)
...
export async function deleteProductImage(c: Context<AppEnv>) {
  try {
    ...
    const images = await ProductService.deleteProductImage(id, imageId, user.id, c.env.DB, c.env.KV, c.env)
...
export async function getProductVariants(c: Context<AppEnv>) {
  try {
    const { id } = c.req.param()
    const variants = await ProductService.getProductVariants(id, c.env.DB)
...
export async function addVariant(c: Context<AppEnv>) {
  try {
    ...
    const variant = await ProductService.addVariant(id, data, user.id, c.env.DB, c.env.KV)
...
export async function updateVariant(c: Context<AppEnv>) {
  try {
    ...
    const variant = await ProductService.updateVariant(variantId, data, user.id, c.env.DB, c.env.KV)
...
export async function deleteVariant(c: Context<AppEnv>) {
  try {
    ...
    await ProductService.deleteVariant(variantId, user.id, c.env.DB, c.env.KV)
...
export async function adjustStock(c: Context<AppEnv>) {
  try {
    ...
    await ProductService.adjustStock(id, variantId || null, data.change, data.reason, user.id, c.env.DB, c.env.KV)
