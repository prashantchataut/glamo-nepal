...
function addSecurityHeaders(response: NextResponse, nonce: string) {
  ...
  const cspDirectives = [
    ...
    "connect-src 'self' https://khalti.com https://pay.khalti.com https://esewa.com.np https://www.esewa.com.np https://www.googleapis.com https://securetoken.googleapis.com https://identitytoolkit.googleapis.com https://www.googletagmanager.com",
