          ...
          >
            <div className="flex items-center justify-between border-b border-brand-border p-5 md:p-6">
              ...
              <button
                ...
                onClick={closeCart}
                className="inline-flex h-11 w-11 items-center justify-center rounded-none text-brand-textMuted transition hover:bg-brand-bgLight hover:text-brand-primary focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-primary focus-visible:ring-offset-2"
              >
            ...
            <div className="border-b border-brand-border bg-brand-bgLight/60 p-5">
              ...
              <div className="h-2 w-full overflow-hidden rounded-none bg-cream-50">
                <div
                  className="h-full rounded-none bg-brand-primary transition-all duration-500 ease-out"
              ...
              {items.length === 0 ? (
                ...
                <div className="space-y-5">
                  {items.map((item) => {
                    ...
                    return (
                      <div key={key} className="rounded-none border border-brand-border bg-cream-50 p-3 shadow-sm">
                        <div className="flex gap-4">
                          <div className="relative h-28 w-24 shrink-0 overflow-hidden rounded-none bg-brand-bgLight">
                            <Image
                          ...
                          <div className="flex min-w-0 flex-1 flex-col">
                            <div className="flex items-start justify-between gap-2">
                              ...
                              <button
                                ...
                                className="inline-flex h-11 w-11 shrink-0 items-center justify-center rounded-none text-brand-textMuted transition hover:bg-brand-bgLight hover:text-red-600 focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-primary focus-visible:ring-offset-2"
                            ...
                            <div className="mt-auto flex items-end justify-between gap-3 pt-4">
                              <div>
                                <div className="flex items-center gap-2 rounded-none border border-brand-border bg-brand-bgLight px-2 py-1">
                                  <button
                                    onClick={() => changeQuantity(item.product.id, item.quantity - 1, item.selectedShade)}
                                    disabled={item.quantity <= 1}
                                    className="inline-flex h-9 w-9 items-center justify-center rounded-none text-brand-textMuted transition hover:bg-cream-50 hover:text-brand-primary disabled:opacity-40"
                                  ...
                                  <button
                                    onClick={() => changeQuantity(item.product.id, item.quantity + 1, item.selectedShade)}
                                    className="inline-flex h-9 w-9 items-center justify-center rounded-none text-brand-textMuted transition hover:bg-cream-50 hover:text-brand-primary"
            ...
            <div className="shrink-0 border-t border-brand-border bg-cream-50 p-5 safe-area-bottom">
              ...
              <Link
                href="/checkout"
                onClick={closeCart}
                className="mt-5 flex w-full items-center justify-center rounded-none bg-brand-primary px-6 py-4 text-sm font-bold text-white shadow-md shadow-brand-primary/15 transition hover:-translate-y-0.5 hover:bg-brand-primary-hover focus:outline-none focus-visible:ring-2 focus-visible:ring-brand-primary focus-visible:ring-offset-2 cursor-pointer"
              >
                Checkout securely
              </Link>
              <Link
