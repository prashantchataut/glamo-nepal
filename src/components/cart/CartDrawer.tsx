    ...
    <>
      {isCartOpen ? (
        <>
          ...
          />
          <div role="dialog" aria-modal="true" aria-label="Shopping cart" className="fixed inset-y-0 right-0 z-cart flex w-full max-w-md flex-col bg-white shadow-2xl translate-x-0 transition-transform duration-300">
