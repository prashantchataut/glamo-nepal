    ...
    <>
      ...
      <div className="lg:hidden">
        <button
          ...
          className="flex min-h-12 w-full items-center justify-between rounded-[1.5rem] border border-neutral-200 bg-white px-4 py-3 shadow-editorial md:rounded-[1.5rem]"
          aria-expanded={mobileExpanded}
        >
          <div className="flex items-center gap-3">
            <span className="text-sm font-semibold text-primary-text">Your bag</span>
        ...
        {mobileExpanded && (
          <div className="mt-2 rounded-[1.5rem] border border-neutral-200 bg-white p-4 shadow-editorial md:rounded-[1.5rem] md:p-5">
      ...
      <aside className="hidden lg:block rounded-[1.5rem] border border-neutral-200 bg-white p-6 shadow-editorial lg:sticky lg:top-24">
        <p className="text-sm font-semibold text-primary-text">Bag summary</p>
    ...
    <>
      {items.map((item) => (
        <div
          ...
          className="flex gap-3 rounded-xl bg-neutral-50 p-2.5 md:rounded-[1.5rem] md:p-3"
        >
          <div className="relative h-14 w-12 shrink-0 overflow-hidden rounded-[0.75rem] bg-neutral-100 md:h-16 md:w-14 md:rounded-xl">
            <Image
...
function CouponSection({
  ...
  return (
    <div className="mb-4">
      <p className="mb-2 text-sm font-semibold text-neutral-500">Promo code</p>
      {couponCode ? (
        <div className="flex items-center justify-between rounded-[1.5rem] border border-primary/30 bg-primary/5 px-4 py-3">
          <div className="flex items-center gap-2">
          ...
          <button
            ...
            className="inline-flex min-h-9 items-center rounded-full px-3 text-xs font-semibold text-neutral-500 transition hover:text-error"
          >
            Remove
          </button>
        </div>
        ...
        <div className="flex gap-2">
          <input
            ...
            className="flex-1 rounded-[1.5rem] border border-neutral-200 bg-white px-4 py-3 text-sm text-neutral-950 placeholder:text-neutral-400 outline-none transition focus:border-primary focus:ring-2 focus:ring-primary/15"
          ...
          <button
            ...
            className="rounded-full bg-primary px-6 py-3 text-sm font-semibold text-neutral-50 transition hover:bg-primary-dark disabled:cursor-not-allowed disabled:bg-neutral-300"
          >
...
function TrustSignals() {
  return (
    <div className="mt-4 space-y-3">
      <div className="flex gap-3 rounded-xl bg-neutral-950 p-3.5 text-white md:rounded-[1.5rem] md:p-4">
        <LockKeyhole size={18} className="mt-0.5 shrink-0 text-secondary" />
        <p className="text-xs leading-5 text-neutral-50/75">Secure checkout. Your details are encrypted and never shared.</p>
      </div>
