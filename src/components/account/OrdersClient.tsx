                ...
                <div className="flex min-w-0 items-center gap-4">
                  ...
                  <div className="min-w-0">
                    <div className="flex flex-wrap items-center gap-2">
                      ...
                      <span className={cn("font-label rounded-full px-3 py-1 text-[10px] font-bold uppercase tracking-[0.14em] ring-1", statusStyles[order.status] || "bg-brand-bgLight text-brand-textMuted ring-brand-border")}>{order.status}</span>
                      {order.source === "session" ? <span className="font-label rounded-full bg-brand-primary-light px-3 py-1 text-[10px] font-bold uppercase tracking-[0.14em] text-brand-primary">New</span> : null}
                    </div>
