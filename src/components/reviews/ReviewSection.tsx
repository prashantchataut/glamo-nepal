    ...
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <label className="block space-y-2 text-sm font-semibold text-neutral-950">
        ...
        <input
          ...
          maxLength={120}
          className="mt-1 w-full rounded-xl border border-neutral-200 bg-[#fffaf7] px-4 py-3 text-sm text-neutral-950 outline-none transition focus:border-primary focus:ring-2 focus:ring-primary/10 placeholder:text-neutral-400"
        />
      </label>
      <label className="block space-y-2 text-sm font-semibold text-neutral-950">
        ...
        <textarea
          ...
          rows={4}
          maxLength={1000}
          className="mt-1 w-full rounded-xl border border-neutral-200 bg-[#fffaf7] px-4 py-3 text-sm leading-7 text-neutral-950 outline-none transition focus:border-primary focus:ring-2 focus:ring-primary/10 placeholder:text-neutral-400"
        />
      </label>
      <button
        type="submit"
  ...
  return (
    <section className="mx-auto max-w-7xl px-4 pb-16 md:px-6 lg:px-8">
      <div className="rounded-[2rem] border border-neutral-200 bg-white p-5 shadow-[0_18px_70px_-54px_rgba(26,21,18,0.55)] md:p-7">
        ...
        {showForm && user && (
          <div className="mt-6 rounded-[1.25rem] border border-neutral-200 bg-[#fffaf7] p-5">
