...
const [email, setEmail] = useState("");
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      const exists = response.data?.accountExists ?? true;
  ...
  return (
    <main className="bg-neutral-100 py-10 md:py-16">
      <div className="container mx-auto max-w-md px-4 md:px-6">
        ...
        {submitted && accountExists === true && (
          <div className={successBoxClasses} role="status" aria-live="polite">
        ...
        {submitted && accountExists === false && (
          <div className={errorBoxClasses} role="status" aria-live="polite">
            <span className="flex items-start gap-3">
              <UserX className="mt-0.5 h-5 w-5 shrink-0" aria-hidden="true" />
