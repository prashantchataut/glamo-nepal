  ...
  return (
    <div className={`w-full overflow-hidden leading-[0] ${className}`}>
      <svg viewBox="0 0 1440 60" preserveAspectRatio="none" className="w-full h-auto block" aria-hidden="true" xmlns="http://www.w3.org/2000/svg">
        <path d="M 0 0 L 1440 0 L 1440 20 Q 1080 60 720 40 Q 360 20 0 50 Z" fill="#FEFCFB" />
      </svg>
    </div>
  )
}
  ...
  return (
    <div className={`flex items-center justify-center ${className}`}>
      <svg viewBox="0 0 200 20" width="200" height="20" aria-hidden="true" xmlns="http://www.w3.org/2000/svg">
        <line x1="0" y1="10" x2="80" y2="10" stroke="#B8860B" strokeWidth="0.75" />
        <text x="90" y="14" fill="#B8860B" fontSize="6" fontFamily="serif">&#9670;</text>
        <line x1="100" y1="10" x2="200" y2="10" stroke="#B8860B" strokeWidth="0.75" />
      </svg>
    </div>
  )
}