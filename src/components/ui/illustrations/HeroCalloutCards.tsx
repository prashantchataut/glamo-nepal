...
export function HeroCalloutCardA({ className = '' }: { className?: string }) {
  return (
    <div
      className={`flex items-center gap-3 rounded-none bg-cream-50 px-4 py-3 shadow-[0_8px_32px_rgba(201,96,122,0.12)] border-l-[3px] border-l-[#D4798A] relative ${className}`}
    >
      ...
      <span className="absolute top-1.5 right-2 w-1 h-1 rounded-none bg-[#B8860B]" />
    </div>
  )
}
...
export function HeroCalloutCardB({ className = '' }: { className?: string }) {
  return (
    <div
      className={`flex items-center gap-2 rounded-none bg-gradient-to-r from-rose-600 to-rose-800 px-4 py-2.5 shadow-[0_8px_24px_rgba(201,96,122,0.28)] ${className}`}
    >
...
export function HeroCalloutCardC({ className = '' }: { className?: string }) {
  return (
    <div
      className={`inline-flex items-center rounded-none border-[1.5px] border-[#B8860B] bg-cream-50 px-4 py-2 shadow-[0_0_16px_rgba(201,168,76,0.2)] ${className}`}
    >
