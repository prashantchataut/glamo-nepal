      ...
      >
        <defs>
          ...
          <radialGradient id="pearlGradM" cx="0.35" cy="0.35" r="0.65">
            ...
            <stop offset="50%" stopColor="#D4A0D7" stopOpacity="0.4" />
            <stop offset="100%" stopColor="#D4A0D7" stopOpacity="0" />
          </radialGradient>
          <filter id="grainM">
        ...
        <g opacity="0.15" fill="none" stroke="#C9A84C" strokeWidth="0.75">
        ...
        <line x1="20" y1="375" x2="70" y2="375" stroke="#C9A84C" strokeWidth="1" />
        <text x="78" y="379" fill="#C9A84C" fontSize="7" fontFamily="serif">&#9670;</text>
    ...
    >
      <defs>
        ...
        <radialGradient id="blobRight" cx="0.5" cy="0.5" r="0.5">
          <stop offset="0%" stopColor="#D4A0D7" stopOpacity="0.35" />
          <stop offset="100%" stopColor="#D4A0D7" stopOpacity="0" />
        </radialGradient>
      ...
      <g opacity="0.2" fill="none" stroke="#C9A84C" strokeWidth="0.75">
      ...
      <line x1="40" y1="380" x2="100" y2="380" stroke="#C9A84C" strokeWidth="1" />
      <text x="108" y="384" fill="#C9A84C" fontSize="8" fontFamily="serif">&#9670;</text>
