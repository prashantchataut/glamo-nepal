      ...
      <svg viewBox="0 0 400 400" preserveAspectRatio="xMidYMid slice" className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
        <defs>
          <pattern id="cardPattern" x="0" y="0" width="40" height="40" patternUnits="userSpaceOnUse">
            <circle cx="20" cy="20" r="1.2" fill="#D4798A" opacity="0.03" />
            <circle cx="5" cy="5" r="0.8" fill="#D4798A" opacity="0.02" />
            <circle cx="35" cy="35" r="0.8" fill="#D4798A" opacity="0.02" />
            <path d="M 10 30 Q 12 28 14 30 Q 12 32 10 30 Z" fill="#D4798A" opacity="0.015" />
          </pattern>
        </defs>
        <rect width="400" height="400" fill="#FEFCFB" />
