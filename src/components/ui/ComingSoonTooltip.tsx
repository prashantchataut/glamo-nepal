    ...
    >
      ...
      {show && (
        <span
          ...
          role="tooltip"
          className="pointer-events-none absolute bottom-full left-1/2 z-[100] mb-2 -translate-x-1/2 whitespace-nowrap rounded-2xl bg-brand-bgDark px-3 py-1.5 text-xs font-medium text-white shadow-lg"
        >
          Coming soon
