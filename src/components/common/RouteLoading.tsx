export function RouteLoading({ label = "Curating GLAMO beauty picks" }: { label?: string }) {
  return (
    <main className="min-h-[60vh] bg-neutral-50 py-16">
      <div className="container mx-auto px-4 md:px-6">
        <div className="mx-auto max-w-3xl rounded-2xl border border-border/70 bg-white p-8 text-center shadow-sm">
          ...
          <p className="font-label mt-5 text-[10px] font-bold uppercase tracking-[0.24em] text-secondary">Loading</p>
          <h1 className="mt-2 font-display text-2xl font-semibold text-neutral-900">{label}</h1>
