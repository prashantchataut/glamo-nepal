  ...
  return (
    <main className="min-h-[60vh] bg-brand-bgLight py-16">
      <div className="container mx-auto px-4 md:px-6">
        <div className="mx-auto max-w-3xl rounded-none border border-border/70 bg-cream-50 p-8 text-center shadow-sm">
          <div className="mx-auto h-12 w-12 rounded-none border-4 border-brand-secondary/30 border-t-brand-primary animate-spin" />
          ...
          <div className="mt-6 grid gap-3 md:grid-cols-3">
            {[1, 2, 3].map((item) => <div key={item} className="h-24 rounded-none skeleton-shimmer" />)}
          </div>
        </div>
      </div>
    </main>
