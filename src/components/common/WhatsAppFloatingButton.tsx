...
export function WhatsAppFloatingButton() {
  ...
  return (
    <a href={SITE_CONFIG.whatsapp} target="_blank" rel="noopener noreferrer" className="group fixed bottom-20 right-4 z-[45] flex items-center gap-3 rounded-full bg-[#25D366] p-4 text-white shadow-2xl shadow-emerald-900/20 transition-transform hover:scale-105 focus:outline-none focus:ring-4 focus:ring-[#25D366]/30 md:bottom-6 md:right-6" aria-label="Chat with us on WhatsApp">
