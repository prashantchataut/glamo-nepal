...
export function WhatsAppFloatingButton() {
  ...
  return (
    <a
      ...
      className="group fixed bottom-20 right-4 z-whatsapp inline-flex h-12 w-12 items-center justify-center rounded-full bg-whatsapp text-neutral-50 shadow-lg shadow-emerald-900/20 transition-transform hover:scale-105 focus:outline-none focus-visible:ring-2 focus-visible:ring-whatsapp focus-visible:ring-offset-2 cursor-pointer md:bottom-24 md:right-6 md:h-14 md:w-14"
      aria-label={label}
    >
