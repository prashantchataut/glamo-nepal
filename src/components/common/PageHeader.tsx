  ...
  return (
    <section className="relative overflow-hidden border-b border-brand-border bg-[var(--gradient-editorial)] py-12 md:py-16">
      ...
      <div className="container relative mx-auto px-4 text-center md:px-6">
        {eyebrow ? <p className="text-xs font-bold uppercase tracking-[0.24em] text-brand-primary">{eyebrow}</p> : null}
        <h1 className="mx-auto mt-3 max-w-4xl font-serif text-4xl font-semibold leading-[0.98] text-brand-textPrimary md:text-6xl">{title}</h1>
