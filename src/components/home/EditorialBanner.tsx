      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid overflow-hidden rounded-[34px] border border-cream-200 bg-brand-blush shadow-[0_28px_90px_-70px_rgba(26,21,18,0.55)] lg:grid-cols-[1fr_0.9fr] lg:items-stretch">
          <div className="px-5 py-8 sm:px-8 md:py-12 lg:p-12">
            <span className="inline-flex rounded-none bg-cream-50 px-4 py-2 text-[10px] font-bold uppercase tracking-[0.22em] text-brand-rose ring-1 ring-white/80">Curated Beauty Edit</span>
            ...
            <div className="mt-7 flex flex-wrap gap-3">
              <Link href="/collections/best-sellers" className="rounded-none bg-ink px-6 py-3 text-xs font-bold uppercase tracking-[0.16em] text-white transition hover:bg-brand-rose">Shop best sellers</Link>
              <Link href="/collections/new-arrivals" className="rounded-none border border-neutral-950/15 bg-cream-50/70 px-6 py-3 text-xs font-bold uppercase tracking-[0.16em] text-ink transition hover:border-brand-rose hover:text-brand-rose">Explore new arrivals</Link>
            </div>
          </div>
