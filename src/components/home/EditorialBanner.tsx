...
export function EditorialBanner() {
  return (
    <section aria-labelledby="editorial-banner-heading" className="bg-[#fffaf7] py-12 md:py-16 lg:py-20">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid overflow-hidden rounded-[34px] border border-neutral-200 bg-[#f7e5f6] shadow-[0_28px_90px_-70px_rgba(26,21,18,0.55)] lg:grid-cols-[1fr_0.9fr] lg:items-stretch">
