...
export function BrandPhilosophyBanner() {
  return (
    <section className="relative py-28 md:py-36 overflow-hidden bg-gradient-to-br from-brand-bgLight via-brand-secondary/10 to-brand-bgLight">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-10 text-center max-w-4xl">
        ...
        <h2 className="font-serif text-5xl md:text-6xl lg:text-7xl font-medium leading-[1.1] mb-8 text-brand-textPrimary">
