    ...
    <section className="relative py-16 md:py-20 lg:py-24 overflow-hidden">
      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
        <div className="max-w-4xl mx-auto">
          <span className="font-label inline-block px-4 py-1.5 bg-brand-primary/10 text-brand-primary text-[10px] font-bold uppercase tracking-[0.2em] rounded-full mb-8 border border-brand-primary/15">
            Our Philosophy
          </span>
