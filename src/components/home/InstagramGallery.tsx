  ...
  return (
    <section aria-labelledby="instagram-heading" className="overflow-hidden bg-white py-12 md:py-16 lg:py-20">
      <div className="container mx-auto px-4 md:px-6 mb-8 md:mb-10 text-center">
        <h2 id="instagram-heading" className="mb-3 font-display text-3xl font-semibold tracking-tight text-neutral-900 md:text-4xl">Follow Our <span className="italic text-primary">Glow Journey</span></h2>
        <a href={SITE_CONFIG.social.instagram} target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 font-medium text-neutral-500 transition-colors hover:text-primary cursor-pointer"><InstagramIcon size={18} /> {SITE_CONFIG.instagramHandle}</a>
      </div>
