    ...
    <section className="bg-white py-12">
      <div className="container mx-auto px-4 md:px-6">
        <div className="mb-6 flex items-end justify-between">
          <div><p className="text-xs font-bold uppercase tracking-[0.22em] text-brand-gold">Your beauty trail</p><h2 className="font-serif text-3xl font-semibold text-brand-textPrimary">Recently viewed</h2></div>
        </div>
