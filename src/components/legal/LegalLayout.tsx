          ...
          <div className="mt-8 space-y-10">
            {sections.map((section) => (
              <section key={section.id} id={section.id} className="scroll-mt-28">
                <h2 className="font-display text-3xl font-semibold text-neutral-900">{section.title}</h2>
                <div className="mt-4 space-y-4 text-sm leading-7 text-neutral-500 md:text-base">
