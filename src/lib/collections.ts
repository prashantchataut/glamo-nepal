...
export const PRODUCT_COLLECTIONS: ProductCollection[] = [
  {
    ...
    seoDescription: "Shop new beauty arrivals at GLAMO NEPAL with रू pricing and delivery across Nepal.",
  ...
  },
  {
    ...
    seoDescription: "Find GLAMO NEPAL beauty products under रू 1,000 across skincare, makeup and personal care.",
  ...
  },
  {
    ...
    seoDescription: "Shop bridal beauty and wedding-season makeup picks at GLAMO NEPAL with रू pricing.",
