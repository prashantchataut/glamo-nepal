export const FAQ_ITEMS = [
  ...
  { question: "Which payment methods are available?", answer: "Khalti, eSewa and Cash on Delivery. A small 3% service fee applies to COD orders; online payments have no extra fee." },
