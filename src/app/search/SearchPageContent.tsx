      ...
      <div className="container mx-auto px-4 py-8 md:px-6 md:py-10">
        {!q ? (
          ...
          <div className="text-center">
            <div className="mx-auto max-w-3xl rounded-[2rem] border border-brand-border bg-white p-8 shadow-sm md:p-12">
              <Sparkles size={46} className="mx-auto mb-4 text-brand-primary/45" />
              <p className="font-serif text-3xl text-brand-textPrimary">No results for “{q}”</p>
              <p className="mt-2 text-brand-textMuted">Try a suggestion or browse these routine-friendly recommendations.</p>
