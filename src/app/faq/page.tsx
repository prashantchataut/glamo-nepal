...
const faqs = [
  ["Do you support Khalti and eSewa?", "GLAMO NEPAL supports Khalti, eSewa, Cash on Delivery and Cards where available. Online payment availability may vary while final merchant setup is completed."],
  ["Is Cash on Delivery available?", "Cash on Delivery availability depends on your district and courier coverage. The checkout page shows availability before you place an order."],
  ["Are these products final?", "The catalog is being finalized with supplier-approved product details, pricing, ingredients and imagery. Please contact GLAMO if you need confirmation before ordering."],
  ...
  ["Are returns supported?", "Returns depend on product condition, seal status and the approved return policy. Beauty products may have special hygiene restrictions."],
];
    ...
    <main className="bg-brand-bgLight">
      ...
      <section className="container mx-auto grid gap-8 px-4 py-12 md:px-6 lg:grid-cols-[0.8fr_1.2fr]">
        <aside className="rounded-[2rem] border border-border/70 bg-white p-6 shadow-sm lg:self-start">
          ...
          <p className="mt-3 text-sm leading-6 text-brand-textMuted">For order support, product confirmation or order questions, contact GLAMO NEPAL directly.</p>
