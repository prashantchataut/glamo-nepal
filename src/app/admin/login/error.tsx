...
export default function AdminLoginError({ reset }: { error: Error & { digest?: string }; reset: () => void }) {
  return (
    <div className="flex min-h-screen items-center justify-center bg-brand-bgLight px-4">
      <div className="mx-auto max-w-md rounded-2xl border border-brand-border bg-cream-50 p-8 text-center shadow-soft">
        ...
        <button
          onClick={reset}
          className="mt-6 inline-flex items-center gap-2 rounded-2xl bg-brand-primary px-6 py-3 font-semibold text-white transition hover:bg-brand-primary-hover"
        >
