...
export default function AdminLoginError({ reset }: { error: Error & { digest?: string }; reset: () => void }) {
  return (
    <div className="flex min-h-screen items-center justify-center bg-brand-bgLight px-4">
      <div className="mx-auto max-w-md rounded-none border border-brand-border bg-cream-50 p-8 text-center shadow-soft">
        <div className="mx-auto flex h-16 w-16 items-center justify-center rounded-none bg-amber-50 text-amber-700">
        ...
        <button
          onClick={reset}
          className="mt-6 inline-flex items-center gap-2 rounded-none bg-brand-primary px-6 py-3 font-semibold text-white transition hover:bg-brand-primary-hover"
        >
