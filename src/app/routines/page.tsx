...
export const metadata = createMetadata({
  ...
  description: "Explore frontend-ready GLAMO NEPAL skincare, makeup and gifting routine bundles with Nepal-market mock pricing.",
  path: "/routines",
    ...
    <main className="min-h-screen bg-brand-bgLight">
      ...
      <section className="bg-brand-bgDark py-16 text-white md:py-24">
        <div className="container mx-auto px-4 text-center md:px-6">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-sm leading-6 text-white/72 md:text-base">Mock bundles for daily glow, sensitive barrier care, festival makeup and Made in Nepal gifting. Backend bundle pricing and supplier-approved claims are still required before launch.</p>
        </div>
      </section>
      <section className="container mx-auto px-4 py-10 md:px-6 md:py-14">
        <div className="mb-7 flex flex-col gap-2 md:flex-row md:items-end md:justify-between">
          ...
          <p className="max-w-xl text-sm leading-6 text-brand-textMuted">These cards make the frontend ready for future cart bundle APIs, quiz-based recommendations and campaign merchandising.</p>
        </div>
