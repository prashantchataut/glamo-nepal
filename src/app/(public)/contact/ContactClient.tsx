...
import { Clock, Facebook, Instagram, Loader2, Mail, MapPin, Phone } from "lucide-react";
          ...
          <div>
            ...
            <div className="bg-white rounded-2xl border border-border/30 p-6 md:p-8 space-y-6">
              ...
              <div className="flex items-center gap-3 pt-4 border-t border-border/30">
                {[
                  { icon: <Instagram size={18} />, href: SITE_CONFIG.social.instagram },
                  { icon: <Facebook size={18} />, href: SITE_CONFIG.social.facebook },
                ].map((s, i) => (
