  ...
  return (
    <main className="min-h-screen bg-neutral-50">
      ...
      <section className="relative overflow-hidden border-b border-neutral-200 bg-hero-gradient">
        <div className="container mx-auto grid gap-10 px-4 py-10 md:px-6 lg:grid-cols-[1fr_0.9fr] lg:py-14">
          <div className="self-center">
            ...
            <p className="text-sm font-semibold text-neutral-500 text-primary">{bundle.eyebrow}</p>
      ...
      <section className="container mx-auto grid gap-8 px-4 py-10 md:px-6 lg:grid-cols-[1fr_360px]">
        <div className="space-y-8">
          <div className="rounded-[1.5rem] bg-white p-6 shadow-sm md:p-8">
            <p className="text-sm font-semibold text-neutral-500 text-secondary">Routine steps</p>
              ...
              {bundle.steps.map((step, index) => {
                ...
                return (
                  <div key={step.productSlug} className="flex gap-4 rounded-3xl border border-border/70 bg-neutral-50 p-4">
                    <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-primary font-bold text-neutral-50">{index + 1}</span>
                    <div>
          ...
          <div>
            <div className="mb-5 flex items-end justify-between gap-4">
              <div>
                <p className="text-sm font-semibold text-neutral-500 text-secondary">Included products</p>
        ...
        <aside className="space-y-5 lg:sticky lg:top-28 lg:self-start">
          ...
          <div className="rounded-[1.5rem] border border-amber-300/60 bg-amber-50 p-5 text-sm text-amber-900">
          ...
          <div className="rounded-[1.5rem] bg-white p-5 text-sm text-neutral-500 shadow-sm">
      ...
      <section className="container mx-auto px-4 pb-14 md:px-6">
        <div className="mb-5">
          <p className="text-sm font-semibold text-neutral-500 text-secondary">More routines</p>
