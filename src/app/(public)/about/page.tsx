...
export default function AboutPage() {
  return (
    <main className="bg-neutral-50 pb-20 md:pb-0">
      ...
      <EditorialSection title="A calmer way to shop beauty." description="The beauty world can be noisy. GLAMO keeps the experience focused: useful categories, honest routines, real delivery expectations and product pages that help customers make confident decisions.">
      ...
      <section className="bg-white py-12 md:py-20">
        <div className="mx-auto grid max-w-7xl gap-10 px-4 md:px-6 lg:grid-cols-2 lg:items-center lg:px-8">
          ...
          <div>
            <h2 className="font-display text-4xl font-medium leading-tight text-neutral-900 md:text-6xl">Make premium beauty feel personal, local and shoppable.</h2>
