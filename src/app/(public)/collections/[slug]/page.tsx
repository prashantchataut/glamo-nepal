    ...
    <main className="min-h-screen bg-neutral-50">
      ...
      <section className="container mx-auto px-4 py-10 md:px-6 md:py-14">
        <div className="mb-6 flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
          <div><p className="font-label text-xs font-bold uppercase tracking-[0.22em] text-primary">Curated edit</p><h2 className="mt-2 font-display text-3xl font-semibold text-neutral-900">{products.length} products</h2></div>
