...
export default function FAQPage() {
  return (
    <main className="bg-neutral-50 pb-20 md:pb-0">
      ...
      <EditorialHero title="Clear answers before you order." description="Everything customers ask most about delivery, payment, product authenticity, returns and shopping with GLAMO Nepal." image={IMAGES.hero.secondary} imageAlt="Luxury skincare flatlay" />
