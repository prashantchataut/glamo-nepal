    ...
    <main className="bg-neutral-50">
      ...
      <section className="mx-auto grid max-w-7xl gap-8 px-4 py-8 md:px-6 md:py-12 lg:grid-cols-[minmax(0,1.08fr)_minmax(380px,0.92fr)] lg:gap-14 lg:px-8">
        <div className="grid gap-4 lg:grid-cols-[88px_minmax(0,1fr)]">
          ...
          <div
            className="order-1 relative aspect-[4/5] overflow-hidden rounded-[2.5rem] border border-neutral-200 bg-neutral-50 shadow-editorial lg:order-2 lg:cursor-zoom-in"
          ...
          <div className="rounded-[2.25rem] border border-neutral-200 bg-white p-5 shadow-card-elevated md:p-7">
            ...
            <div className="mt-6 grid gap-3">
              {reassurance.map(({ label, text, icon: Icon }) => (
                <div
                  key={label}
                  className="flex gap-3 rounded-[1.35rem] border border-neutral-200 bg-neutral-50 p-4"
                >
